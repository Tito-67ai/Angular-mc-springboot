...
public class RabbitMQConfig {
    ...
    public static final String COLA_NOTIFICACIONES = "microservicios.cola.administracion";
    ...
    public Binding binding(Queue colaNotificaciones, TopicExchange microserviciosExchange) {
        return BindingBuilder.bind(colaNotificaciones).to(microserviciosExchange).with("alumno.*");
    }
